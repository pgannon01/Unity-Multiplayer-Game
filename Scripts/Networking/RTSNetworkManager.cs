...
public class RTSNetworkManager : NetworkManager
{
    ...
    public void StartGame()
    {
        if (Players.Count < 2)
        {
            return; // Don't start with less than 2 people
        }

        isGameInProgress = true;

        ServerChangeScene("Scene_Test_01");
    }
    ...
    public override void OnServerAddPlayer(NetworkConnection conn)
    {
        ...
        player.SetIsPartyOwner(Players.Count == 1); // Set whoever's there first as the party owner
    }
